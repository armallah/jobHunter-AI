...
"""
Possible next steps:
1. Prompt for additional arguments (e.g. search keywords or location).
2. Safely store credentials or handle them securely.
3. Add exception handling for PDF extraction or job scraping steps.
c
"""
